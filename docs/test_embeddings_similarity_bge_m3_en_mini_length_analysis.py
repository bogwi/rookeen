...
def test_bge_small_en_length_sensitivity_analysis() -> None:
    """Test BGE-small-en-v1.5 embeddings sensitivity to text length.
    ...
    # Initialize backend with BGE-small-en-v1.5 (English-specific, smaller/faster than BGE-M3)
    backend = get_backend("bge-m3", model_name="BAAI/bge-small-en-v1.5")
    backend.load()
    
    # Test similar pairs
    print("\n" + "=" * 80)
    print("SIMILAR PAIRS - Similarity Scores (BGE-small-en-v1.5)")
    print("=" * 80)
    similar_scores = []
    ...
    print("\n" + "=" * 80)
    print("DISSIMILAR PAIRS - Similarity Scores (BGE-small-en-v1.5)")
    print("=" * 80)
    dissimilar_scores = []
