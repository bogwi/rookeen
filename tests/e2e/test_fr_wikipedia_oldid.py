...
URL = "https://fr.wikipedia.org/w/index.php?title=Traitement_automatique_du_langage_naturel&oldid=214340480"

# Networked Wikipedia; exclude from default runs
pytestmark = [pytest.mark.external]


def test_fr_wikipedia_oldid() -> None:
    out_base: Path = unique_output_base("fr-wikipedia-org")
