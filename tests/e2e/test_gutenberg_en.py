...
URL = "https://www.gutenberg.org/cache/epub/396/pg396.txt"

# Networked content; exclude from default runs
pytestmark = [pytest.mark.external]


def test_gutenberg_lady_or_the_tiger() -> None:
    out_base: Path = unique_output_base("gutenberg-en")
    ...
    # has approximately 2.700 words, expect reasonable token count
